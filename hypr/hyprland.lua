...
-- The legacy hyprland.conf is intentionally preserved as a fallback/backup.
...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("kitty zsh -ic \"fastfetch; exec zsh\"", { workspace = "1" })
...
-- Preserved from the legacy example configuration. It only applies if this
-- exact input device is present.
hl.device({
    name = "epic-mouse-v1",
    sensitivity = -0.5,
})
